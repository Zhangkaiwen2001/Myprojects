...
#include <memory>
#include "D:/MyProjects/Qt/Mathcheck4.0/choosewindow.h"
...
QT_MOC_LITERAL(1, 13, 10), // "chooseBcak"
QT_MOC_LITERAL(2, 24, 0) // ""

    },
    "chooseWindow\0chooseBcak\0"
};
...
void chooseWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->chooseBcak(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (chooseWindow::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&chooseWindow::chooseBcak)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject chooseWindow::staticMetaObject = { {
    QMetaObject::SuperData::link<QMainWindow::staticMetaObject>(),
    qt_meta_stringdata_chooseWindow.data,
    qt_meta_data_chooseWindow,
    qt_static_metacall,
    nullptr,
    nullptr
} };
