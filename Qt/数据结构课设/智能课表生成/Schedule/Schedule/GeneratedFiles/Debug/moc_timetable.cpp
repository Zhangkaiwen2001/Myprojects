...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_timeTable_t, stringdata) + ofs \
...
const QMetaObject timeTable::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_timeTable.data,
...
void *timeTable::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_timeTable.stringdata))
