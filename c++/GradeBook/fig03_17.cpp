...
int main()
{
    ...
    GradeBook gradeBook1( "CS101 Introduction to Programming in C++","teacher1" );
    GradeBook gradeBook2( "CS102 C++ Data Structures","teacher2" );

    // display each GradeBook's courseName
    cout << "gradeBook1's initial course name is: "
         << gradeBook1.getCourseName()
         <<"\nteacherName1's initial name is: "
         << gradeBook1.getTeacherName()
         << "\ngradeBook2's initial course name is: "
         << gradeBook2.getCourseName()
         <<"\nteacherName2's initial name is: "
    ...
    // display each GradeBook's courseName
    cout<<"\n";
    cout << "gradeBook1's course name is: "
         << gradeBook1.getCourseName()
         <<"\nteacherName1's name is: "
         << gradeBook1.getTeacherName()
         << "\ngradeBook2's course name is: "
         << gradeBook2.getCourseName()
         <<"\nteacherName2's name is: "
         << gradeBook2.getTeacherName();
    cout<<"\n";
